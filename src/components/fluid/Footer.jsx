                        ...
                        <div className={styles["lower-footer-content-right"]}>
                            <div className={styles["lower-footer-content-right-social-links"]}>
                                ...
                                <a target="_blank" onClick={(e) => {e.preventDefault(); gtmPush(["callback", "foot_2_social_linkedin", ()=>{router.push(`https://www.linkedin.com/company/semper-home-loans`);}]);}}><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <a target="_blank" onClick={(e) => {e.preventDefault(); gtmPush(["callback", "foot_2_social_insta", ()=>{router.push(`https://www.instagram.com/homeeasyhomes/`);}]);}}><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 448 512">
                                        <path
                                    ...
                                    <a target="_blank" onClick={(e) => {e.preventDefault(); gtmPush(["callback", "foot_2_social_fb", ()=>{router.push(`https://www.facebook.com/profile.php?id=100095337559849&mibextid=LQQJ4d`);}]);}}><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 320 512">
                                        <path
