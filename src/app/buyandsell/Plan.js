    ...
    return (
        <div className={styles['main-component']}>
            ...
            <div className={styles['main-copy-container']}>Unlock our unmatched expertise with our free tools and calculators to empower your real estate journey.</div>
                ...
                <div className={styles['image-holder']}> <a onClick={()=>{gtmPush(["callback", "plan_card_1", ()=>{router.push(`/calculators`);}]);}} ><img src="/img/card1.png" alt="how much can I make selling my house" /></a></div>
                <div className={styles['image-holder']}> <a onClick={()=>{gtmPush(["callback", "plan_card_2", ()=>{router.push(`/calculators`);}]);}} ><img src="/img/card2.png" alt="savings calculator" /></a></div>
                <div className={styles['image-holder']}> <a onClick={()=>{gtmPush(["callback", "plan_card_3", ()=>{router.push(`/calculators`);}]);}} ><img src="/img/card3.png" alt="estimated payments" /></a></div>
                </div>
            </motion.div>
        </div>
